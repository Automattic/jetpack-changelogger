...
### Removed
- Remove `Utils::error_clear_last()`, the function can be called directly now.
...
[4.0.2-alpha]: https://github.com/Automattic/jetpack-changelogger/compare/4.0.1...4.0.2-alpha
